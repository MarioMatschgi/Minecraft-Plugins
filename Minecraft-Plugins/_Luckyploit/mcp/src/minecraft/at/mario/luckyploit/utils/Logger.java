...
public class Logger {
	...
	public void sendChatWithPrefix(String msg) {
		mc.thePlayer.addChatMessage(new ChatComponentText(Luckyploit.prefix + msg));
	}
	public void sendChatError(String msg) {
		mc.thePlayer.addChatMessage(new ChatComponentText(Luckyploit.prefix + "§f[§cError§f]: " + msg));
	}
	public void sendChatInfo(String msg) {
		mc.thePlayer.addChatMessage(new ChatComponentText(Luckyploit.prefix + "§f[§9Info§f]: " + msg));
	}
}
