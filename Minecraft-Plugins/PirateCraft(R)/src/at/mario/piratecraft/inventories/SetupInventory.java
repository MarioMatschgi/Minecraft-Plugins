...
public class SetupInventory {
	...
	public void newInventory(String arena, Player p) {
		...
		ItemStack setSpawnblock = new ItemStack(Material.BEDROCK);
		ItemMeta setSpawnblockMeta = setSpawnblock.getItemMeta();
		setSpawnblockMeta.setDisplayName(mm.getMessages().getString("Messages.gui.setup.setDestroyblock"));
		ArrayList<String> setSpawnblocklist = new ArrayList<String>();
		setSpawnblocklist.add("§b" + ploc.getWorld().getName());
		setSpawnblocklist.add(" ");
		setSpawnblocklist.add("§3X§f: §6" + (int) ploc.getX() + " §3Y§f: §6" + (int) ploc.getY() + " §3Z§f: §6" + (int) ploc.getZ());
		setSpawnblocklist.add(" ");
		setSpawnblocklist.add("§bYaw§f: §6" + (int) ploc.getYaw());
		setSpawnblocklist.add("§bPitch§f: §6" + (int) ploc.getPitch());
		setSpawnblockMeta.setLore(setSpawnblocklist);
		setSpawnblock.setItemMeta(setSpawnblockMeta);
