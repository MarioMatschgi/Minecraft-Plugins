...
public class SetupInventory {
	...
	public void newInventory(String arena, Player p) {
		...
		Inventory inv = Main.getPlugin().getServer().createInventory(null, 54, mm.getMessages().getString("Messages.inventory.setup.title").replace("%arena%", arena));
		...
		infoMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.info"));
		...
		setLobbySpawnMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.setLobbySpawn"));
		...
		setSpawnMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.setSpawn"));
		...
		setBound1Meta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.setBound1"));
		...
		setBound2Meta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.setBound2"));
		...
		minPlayerPlusMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.minPlayerPlus"));
		...
		minPlayerInfoMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.minPlayerInfo").replace("%minplayers%", minplayer+""));
		...
		minPlayerNegMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.minPlayerNeg"));
		...
		maxPlayerPlusMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.maxPlayerPlus"));
		...
		maxPlayerInfoMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.maxPlayerInfo").replace("%maxplayers%", maxplayer+""));
		...
		maxPlayerNegMeta.setDisplayName(mm.getMessages().getString("Messages.inventory.setup.maxPlayerNeg"));
