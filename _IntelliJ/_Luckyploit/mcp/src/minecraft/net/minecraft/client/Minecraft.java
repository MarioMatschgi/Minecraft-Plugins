...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        if (gameConfig.serverInfo.serverName != null)
        {
            ...
            // INJEKTION: LUCKYPLOIT-EVENTS REGISTRIEREN
            EventManager.register(new Luckyploit());
        }
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        // INJEKTION: LUCKYPLOIT STARTEN
        new Luckyploit().startClient();
    ...
    private void createDisplay() throws LWJGLException
    {
		...
		Display.setTitle("Loading " + Luckyploit.CLIENT_NAME + " v" + Luckyploit.CLIENT_VERSION + " Mc: " + Luckyploit.MINECRAFT_VERSION + "...");
