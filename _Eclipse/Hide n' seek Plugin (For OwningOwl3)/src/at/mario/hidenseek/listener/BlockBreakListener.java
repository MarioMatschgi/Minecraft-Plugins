...
public class BlockBreakListener implements Listener {
	...
	public void signDetachCheck(BlockPhysicsEvent event) {
		...
		if (block.getType() == Material.WALL_SIGN || block.getType() == Material.LEGACY_SIGN_POST || block.getType() == Material.SIGN || block.getType() == Material.LEGACY_SIGN || block.getType() == Material.LEGACY_WALL_SIGN) {
