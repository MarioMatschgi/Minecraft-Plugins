...
public class SetupInventory {
	...
	public void newInventory(String arena, Player p) {
		...
		Inventory inv = Main.getPlugin().getServer().createInventory(null, 54, mm.getMessages().getString("Messages.gui.setup.title"));
		...
		*/
		...
		ItemStack setSpawn = new ItemStack(Material.LEGACY_BED);
		...
		ItemStack setBound1 = new ItemStack(Material.LEGACY_FENCE);
		...
		ItemStack setBound2 = new ItemStack(Material.LEGACY_FENCE_GATE);
		...
		ItemStack minPlayerPlus = new ItemStack(Material.LIME_CONCRETE, 1);
		...
		ItemStack minPlayerNeg = new ItemStack(Material.RED_CONCRETE, 1, (short) 14);
		...
		ItemStack maxPlayerPlus = new ItemStack(Material.LIME_CONCRETE, 1);
		...
		ItemStack maxPlayerNeg = new ItemStack(Material.RED_CONCRETE, 1);
